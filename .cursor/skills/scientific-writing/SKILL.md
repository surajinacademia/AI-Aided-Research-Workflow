...
1. **Generate figure during analysis** (follow python-coding-standards.mdc)
...
See [EXAMPLE.md](EXAMPLE.md) for a complete scientific results document demonstrating all principles.
